...
- `archive/YYYY/MM/YYYY-MM-DD.html`：历史归档网页。
- `assets/YYYY-MM-DD/`：当天图片素材。
- `templates/index.html`：今日网页模板。
- `scripts/archive_today.py`：归档当前页并重置首页。
- `scripts/update_index.py`：更新归档索引。
- `scripts/check_files.py`：检查结构规则。
